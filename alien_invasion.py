...
class AlienInvasion:
	...
	def __init__(self):
		"""Запуск игры и создания ресурсов."""
		pygame.init()
	...
	def _update_bullets(self):
		"""Обновление позиции снарядов и их уничтожение"""
		self.bullets.update()
	...
	def _create_fleet(self):
		...
		# Интервал между соседнгими пришельцами равен ширине пришельца.
		alien = Alien(self)
	...
	def _update_screen(self):
		...
		# Если игра не активна, кнопки Плей нет
